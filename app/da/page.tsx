...
export default function DanskPage() {
  return (
      ...
      <main className="flex-1 py-xl bg-surface">
        <div className="max-w-container-max mx-auto px-gutter text-center">
          ...
          <h1 className="text-headline-xl font-manrope font-bold mb-md">
            Danmarks Markedsplads for Virksomheder
          </h1>
          <p className="text-body-lg font-inter text-secondary max-w-xl mx-auto mb-xl">
            Køb og sælg verificerede virksomheder, udstyr og kommercielle aktiver på tværs af Danmark — uden mæglere, uden skjulte gebyrer.
          </p>
